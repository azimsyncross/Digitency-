...
import { ArrowRight, BarChart, TrendingUp, Target } from "lucide-react";
      ...
      <div className="container mx-auto max-w-7xl px-4 py-20 md:py-32">
        ...
        >
          ...
          <div className="flex flex-col justify-center text-center lg:text-left">
            ...
            >
              We specialize in crafting personalized digital marketing solutions that increase traffic, boost conversions, and grow your brand sustainably.
            </motion.p>
            <motion.div
              variants={itemVariants}
            ...
            >
              ...
              >
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Boost your search rankings and organic traffic with our expert SEO strategies.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="font-semibold text-foreground">Pay-Per-Click Ads</p>
                <p className="mt-1 text-sm text-muted-foreground">
                  Maximize ROI with highly targeted PPC campaigns tailored for your audience.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="font-semibold text-foreground">Social Media Marketing</p>
                <p className="mt-1 text-sm text-muted-foreground">
                  Engage and grow your community across platforms with creative social media strategies.
                </p>
              </motion.div>
              ...
              >
                <p className="font-semibold text-foreground mb-2">Content Marketing</p>
                <p className="text-sm text-muted-foreground">
                  Drive brand authority and customer loyalty with compelling, SEO-optimized content.
                </p>
              </motion.div>
            </motion.div>
          </div>
