...
const testimonialsData = [
  {
    quote: "Working with Digitency was a game-changer. Their SEO strategy doubled our organic traffic in just six months. We couldn't be happier with the results.",
    name: "Sarah Johnson",
  ...
  {
    quote: "As a local business, we struggled to get noticed online. Digitency's local SEO services put us on the map. Our foot traffic has increased by over 70%.",
            ...
            <AnimatePresence initial={false} custom={direction} mode="wait">
                ...
                >
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-xl italic text-foreground">"{testimonialsData[testimonialIndex].quote}"</p>
                        <div className="mt-6 flex items-center justify-center gap-4">
                            <img className="h-12 w-12 rounded-full object-cover" src={testimonialsData[testimonialIndex].avatar} alt={testimonialsData[testimonialIndex].name} />
                            <div>
                                <p className="font-semibold text-foreground">{testimonialsData[testimonialIndex].name}</p>
                                <p className="text-sm text-muted-foreground">{testimonialsData[testimonialIndex].title}</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
