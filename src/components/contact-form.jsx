...
import { User, Mail, Phone, MapPin, Clock, ChevronDown, Send, MessageCircle, CheckCircle, Loader2 } from "lucide-react";

// Reusable Input Field Component
const InputField = ({ label, type = "text", name, placeholder, required = false, children }) => (
...
const ContactCard = ({ icon: Icon, title, value, delay }) => (
  ...
  >
    ...
    <div className="relative z-10">
      ...
      <p className="text-muted-foreground whitespace-pre-line leading-relaxed">{value}</p>
    </div>
  </motion.div>
);
...
const contactInfo = [
  { icon: User, title: "Full Name", value: "ARTIA ANGELIC BOYD", delay: 0.1 },
  { icon: Mail, title: "Email Contact", value: "perryalexanderojd163@hotmail.com", delay: 0.2 },
  { icon: Phone, title: "Primary Phone Number", value: "+1 612-355-8326", delay: 0.3 },
  { 
    icon: MapPin, 
    title: "Office Location", 
    value: "Northeast Alberta Street 6250\nPortland, OR 97218\nUnited States of America", 
    delay: 0.4 
  },
  { icon: Clock, title: "Business Hours", value: "Mon-Fri: 9:00 AM - 6:00 PM CST", delay: 0.5 }
];
  return (
      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We're dedicated to your business success. Contact us through any channel, and we'll respond with strategic insights within 24 hours.
          </p>
        </motion.div>
            ...
            <div className="relative">
              ...
              <div className="relative z-10 border border-border/50 rounded-2xl p-8 lg:p-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="text-3xl font-bold text-foreground">Send Us a Message</h3>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <InputField label="Full Name" name="fullname" placeholder="Enter your full name" required />
                      <InputField label="Email Address" type="email" name="email" placeholder="your.email@example.com" required />
                      <InputField label="Company Name" name="company" placeholder="Your company name" />
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                      <InputField label="Service Interest" name="service">
                        <div className="relative">
                          <select id="service" name="service" className="block w-full appearance-none rounded-lg border border-border bg-background/50 p-4 text-foreground focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 hover:border-primary/50">
                      ...
                      <InputField label="Budget Range" name="budget">
                        <div className="relative">
                          <select id="budget" name="budget" className="block w-full appearance-none rounded-lg border border-border bg-background/50 p-4 text-foreground focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 hover:border-primary/50">
                    ...
                    <div>
                      <label htmlFor="details" className="text-sm font-medium text-primary block mb-2">
